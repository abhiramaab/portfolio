...
export const projects = [
  ...
  },
  {
    ...
    tagline: 'Distributed Payment & Ledger Orchestration Engine',
    github: 'https://github.com/abhiramaab/loompay',
    live: 'https://loompay.abhiram.tech',
    description: 'High-throughput payment orchestration engine implementing Redis distributed mutex locks (SET NX EX), double-checked idempotency, Transactional Outbox pattern, Consistent Hashing 360° ring router with virtual replicas, and automated reconciliation.',
    desc: 'High-throughput payment orchestrator with Redis distributed mutex locks (SET NX EX), Transactional Outbox pattern, Consistent Hashing 360° ring router, and double-entry bookkeeping ledger.',
    tags: ['Java 21', 'Spring Boot', 'Redis', 'PostgreSQL', 'System Design', 'Docker'],
    external: true,
  },
]
...
export const stack = {
  items: [
    ...
    'Distributed Systems (Locks, Outbox, Hashing)',
    'Microservices',
