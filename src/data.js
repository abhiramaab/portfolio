...
export const projects = [
  ...
  },
  {
    ...
    tagline: 'Payment gateway with distributed locks, outbox events, and ledger bookkeeping.',
    github: 'https://github.com/abhiramaab/loompay',
    live: 'https://loompay.abhiram.tech',
    description: 'Payment backend built in Java 21 and Spring Boot. Uses Redis locks to prevent duplicate charges, an outbox table to reliably deliver webhooks, consistent hashing to route merchants, and double-entry accounting to track balances.',
    desc: 'Payment backend with Redis distributed locks, Transactional Outbox event dispatching, Consistent Hashing routing, and double-entry accounting.',
